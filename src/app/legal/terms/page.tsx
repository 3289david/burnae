  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12 prose-sm">
        ...
        <p className="text-sm text-text-dim mt-2">시행일: 2026년 8월 29일</p>
        ...
        <Section title="제2조 (서비스의 내용)">
          ...
          호스팅 등 회사가 정한 서버 종류를 생성·관리·삭제할 수 있도록 하며, 콘솔 접속, 파일 관리, 백업,
          시작 변수(환경변수) 편집, 서버 종류에 따른 플레이어 관리·플러그인/모드 설치, AI 챗봇을 통한 서버
          관리 보조 기능 등을 제공합니다. 회사는 운영 정책에 따라 특정 시점에 제공하는 서버 종류의 범위를
